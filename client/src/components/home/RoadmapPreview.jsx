...
export default function RoadmapPreview() {
  ...
  return (
    <section id="paths" className="py-16 md:py-24 max-w-[1200px] mx-auto px-4 sm:px-6 lg:px-8">
          ...
          return (
            <button
              ...
              className={`text-left p-5 rounded-[12px] border transition-all ${
                isSelected
                  ? "bg-[#1a3300] text-[#fcfaf5] border-[#1a3300] shadow-[rgba(0,0,0,0.06)_0px_2px_6px]"
            ...
            >
              <div className="flex items-center justify-between mb-2">
                ...
                {isSelected && <Flame className="w-4 h-4 text-[#ffe95c]" />}
              </div>
      ...
      <div className="bg-[#fcfaf5] border-2 border-[#1a3300] rounded-[16px] p-6 sm:p-10 shadow-[rgba(0,0,0,0.05)_0px_4px_12px]">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
          {currentTrack.steps.map((step, i) => (
            <div
              key={i}
              className="bg-[#fcfaf5] border border-[#1a3300]/40 rounded-[10px] p-4 flex flex-col justify-between hover:border-[#1a3300] transition-colors"
            >
              <div>
                <div className="flex items-center justify-between mb-2">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4 pt-6 border-t border-[#b6b6b6]/40">
          ...
          <Link
            href="/paths"
            className="inline-flex items-center gap-2 bg-[#1a3300] text-[#fcfaf5] text-[14px] font-medium px-5 py-2.5 rounded-[6px] hover:bg-[#1a3300]/90 transition-colors"
          >
