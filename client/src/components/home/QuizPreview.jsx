      ...
      <div className="bg-[#a8e5e5] border-2 border-[#1a3300] rounded-[16px] p-6 sm:p-10 lg:p-12 shadow-[rgba(0,0,0,0.06)_0px_4px_12px]">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
          ...
          <div className="lg:col-span-5 flex flex-col justify-between">
            <div>
              <div className="inline-flex items-center gap-2 bg-[#1a3300] text-[#fcfaf5] px-3 py-1 rounded-[4px] text-[11px] font-mono font-medium mb-4">
          ...
          <div className="lg:col-span-7 bg-[#fcfaf5] border-2 border-[#1a3300] rounded-[12px] p-6 sm:p-8 shadow-[rgba(0,0,0,0.05)_0px_2px_6px]">
              ...
              {sampleQuestion.options.map((option) => {
                ...
                return (
                  <button
                    ...
                    className={`w-full text-left p-3.5 rounded-[6px] border text-[14px] flex items-center justify-between transition-all ${optionStyle}`}
                  >
            ...
            {isSubmitted && chosenObj && (
              <div
                className={`p-4 rounded-[6px] mb-5 text-[13px] border ${
                  chosenObj.isCorrect
            ...
            <div className="flex items-center justify-between pt-4 border-t border-[#b6b6b6]/30">
              <button
                onClick={handleReset}
                className="inline-flex items-center gap-1.5 text-[13px] font-mono text-[#1a3300]/70 hover:text-[#1a3300]"
              >
              ...
              {!isSubmitted ? (
                <button
                  ...
                  className={`px-5 py-2 rounded-[6px] text-[14px] font-medium transition-all ${
                    selectedOption
                ...
                <Link
                  href="/quizzes"
                  className="inline-flex items-center gap-1.5 bg-[#1a3300] text-[#fcfaf5] text-[14px] font-medium px-5 py-2 rounded-[6px] hover:bg-[#1a3300]/90"
                >
