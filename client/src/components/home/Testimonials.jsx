    ...
    <section id="community" className="py-16 md:py-24 max-w-[1200px] mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8">
        {reviews.map((rev) => (
          <div
            key={rev.id}
            className={`${rev.bg} ${rev.border} rounded-[14px] p-7 flex flex-col justify-between sticky-card shadow-[rgba(0,0,0,0.04)_0px_2px_4px]`}
          >
            <div>
            ...
            <div className="pt-4 border-t border-[#1a3300]/20 flex items-center gap-3">
              <div className="w-8 h-8 rounded-full bg-[#1a3300] text-[#fcfaf5] flex items-center justify-center font-bold text-[12px]">
                {rev.author[0]}
              </div>
