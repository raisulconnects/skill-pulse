  ...
  return (
    <section className="relative w-full pt-12 pb-20 md:pt-20 md:pb-28 overflow-hidden">
      ...
      <div className="relative max-w-[1200px] mx-auto px-4 sm:px-6 lg:px-8 flex flex-col items-center text-center">
        {/* Tagline Badge */}
        <div className="inline-flex items-center gap-2 bg-[#ffe95c] border border-[#1a3300]/15 px-3 py-1 rounded-[6px] text-[12px] sm:text-[13px] font-medium text-[#1a3300] mb-6 shadow-[rgba(0,0,0,0.03)_0px_1px_2px]">
        ...
        <h1 
          className="font-bricolage text-[#1a3300] text-[46px] sm:text-[62px] lg:text-[76px] font-[800] leading-[1.05] tracking-[0.04em] max-w-[950px] mb-6"
          style={{ fontFamily: "var(--font-bricolage-grotesque), var(--font-bricolage), sans-serif" }}
        >
          Master tech skills{" "}
          <span className="bg-[#ffe95c] px-3 py-0.5 rounded-[4px] inline-block -rotate-1 shadow-[rgba(0,0,0,0.05)_0px_1px_2px]">
            faster
          </span>{" "}
        ...
        {/* Subhead Paragraph */}
        <p className="text-[17px] sm:text-[19px] lg:text-[20px] text-[#1a3300]/85 leading-[1.5] max-w-[640px] mb-8 font-normal">
        ...
        <div className="flex flex-col sm:flex-row items-center gap-4 w-full sm:w-auto justify-center mb-5">
          <Link
            href="/courses"
            className="w-full sm:w-auto inline-flex items-center justify-center gap-2 bg-[#1a3300] text-[#fcfaf5] text-[16px] font-medium px-8 py-4 rounded-[6px] hover:bg-[#1a3300]/90 transition-all active:scale-[0.98] shadow-[rgba(0,0,0,0.05)_0px_1px_2px_0px]"
          >
          ...
          <Link
            href="#paths"
            className="w-full sm:w-auto inline-flex items-center justify-center gap-2 bg-[#d5f5c2] border border-[#1a3300] text-[#1a3300] text-[16px] font-medium px-8 py-4 rounded-[6px] hover:bg-[#d5f5c2]/80 transition-all active:scale-[0.98]"
          >
            <Terminal className="w-4 h-4" />
            <span>Interactive Skill Paths</span>
          </Link>
        </div>
