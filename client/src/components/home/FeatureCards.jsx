      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
        {features.map((item) => {
          ...
          return (
            <div
              key={item.id}
              className={`${item.bgColor} ${item.border} rounded-[14px] p-7 sm:p-8 flex flex-col justify-between sticky-card shadow-[rgba(0,0,0,0.04)_0px_2px_4px]`}
            >
              <div>
                <div className="flex items-center justify-between mb-6">
                  ...
                  <div className="w-10 h-10 rounded-[8px] bg-[#1a3300]/10 flex items-center justify-center text-[#1a3300]">
